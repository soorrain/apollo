...
public class NamespaceController {
  ...
  public NamespaceDTO create(@PathVariable("appId") String appId,
    ...
    // 校验 NamespaceDTO 的 `namespaceName` 属性格式正确
    ...
    // 将 NamespaceDTO 转换为 Namespace 对象
    Namespace entity = BeanUtils.transfrom(Namespace.class, dto);
    // 判断 `namespaceName` 在 Cluster 下是否已经存在对应的 Namespace 对象。若已经存在，抛出 BadRequestException 异常
    ...
    // 将保存的 Namespace 对象转换为 NamespaceDTO 返回
